...
AC_DEFUN([MATE_COMPILE_WARNINGS],[
	...
	;;
    maximum|error)
	warning_flags="-Wall -Wextra -Wconversion -Wunused-macros -Wunused-parameter -Wmissing-prototypes -Wbad-function-cast -Wcast-align -Wno-unused-parameter -Wformat-nonliteral -Wmissing-declarations -Wmissing-field-initializers -Wnested-externs -Wpointer-arith -Wredundant-decls -Wshadow -Wstrict-prototypes -Werror=format-security"
